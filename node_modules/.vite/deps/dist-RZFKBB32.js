...
import {
  Hls
} from "./chunk-LCJ3EVCK.js";
import {
  CustomVideoElement,
  MediaTracksMixin
} from "./chunk-RRLTMNRJ.js";
import {
  require_react
...
var wr = B(function(As, Tr) {
  ...
  function Fa(r12) {
    var e2 = [];
    for (var t3 in r12) Ha2(r12, t3) && e2.push({ name: t3, value: r12[t3] });
...
var rt = B(function(Ps, kr) {
  ...
  function I4(r12, e2, t3) {
    if (!U(this, I4)) return new I4(r12);
...
var Et = function(r12) {
  ...
  return { trace: function() {
    ...
    for (var T3 = arguments.length, x7 = new Array(T3), m6 = 0; m6 < T3; m6++) x7[m6] = arguments[m6];
    if (!(c4 > Y.DEBUG)) return b5.apply(void 0, W(x7));
  }, info: function() {
    for (var T3 = arguments.length, x7 = new Array(T3), m6 = 0; m6 < T3; m6++) x7[m6] = arguments[m6];
    if (!(c4 > Y.INFO)) return p6.apply(void 0, W(x7));
  }, warn: function() {
    for (var T3 = arguments.length, x7 = new Array(T3), m6 = 0; m6 < T3; m6++) x7[m6] = arguments[m6];
    if (!(c4 > Y.WARN)) return k3.apply(void 0, W(x7));
  }, error: function() {
    for (var T3 = arguments.length, x7 = new Array(T3), m6 = 0; m6 < T3; m6++) x7[m6] = arguments[m6];
      ...
      if (typeof document != "undefined") {
        ...
        for (var p6 = document.cookie ? document.cookie.split("; ") : [], b5 = /(%[0-9A-Z]{2})+/g, k3 = 0; k3 < p6.length; k3++) {
          ...
          try {
            ...
            if (c4 = t3.read ? t3.read(c4, v4) : t3(c4, v4) || c4.replace(b5, decodeURIComponent), this.json) try {
              c4 = JSON.parse(c4);
            } catch (T3) {
            }
            if (a3 === v4) {
...
var Yt2 = (e2, t3) => {
  ...
  } else a3 = new f(e2.error.message, f.MEDIA_ERR_ENCRYPTED, e2.fatal), a3.errorCategory = C2.DRM, a3.muxCode = b.ENCRYPTED_ERROR;
...
var getSubtitleTracks = (stateOwners) => {
  ...
  }).sort((a3, b5) => a3.kind >= b5.kind ? 1 : -1);
};
...
handlePointerMove_fn3 = function(evt) {
  const isOverBoxes = [...__privateGet19(this, _boxes)].some(
    (b5) => evt.composedPath().includes(b5)
  );
...
var operators = {
  ...
  "|": (a3, b5) => {
    var _a4;
    return (_a4 = pipeModifiers[b5]) == null ? void 0 : _a4.call(pipeModifiers, a3);
  }
};
...
var ua2 = (t3, a3 = false) => {
  ...
  if (t3.muxCode) {
    ...
    if (t3.muxCode === b.NETWORK_OFFLINE) return x("Your device appears to be offline", a3);
    if (t3.muxCode === b.NETWORK_TOKEN_EXPIRED) return x("{category} URL has expired", a3).format({ category: r12 });
    if ([b.NETWORK_TOKEN_SUB_MISMATCH, b.NETWORK_TOKEN_AUD_MISMATCH, b.NETWORK_TOKEN_AUD_MISSING, b.NETWORK_TOKEN_MALFORMED].includes(t3.muxCode)) return x("{category} URL is formatted incorrectly", a3).format({ category: r12 });
    if (t3.muxCode === b.NETWORK_TOKEN_MISSING) return x("Invalid {categoryName} URL", a3).format({ categoryName: n3 });
    if (t3.muxCode === b.NETWORK_NOT_FOUND) return x("{category} does not exist", a3).format({ category: r12 });
...
var ca2 = (t3) => {
  if (t3.muxCode) {
    if (t3.muxCode === b.NETWORK_TOKEN_EXPIRED) return "403-expired-token.md";
    if (t3.muxCode === b.NETWORK_TOKEN_MALFORMED) return "403-malformatted-token.md";
    if ([b.NETWORK_TOKEN_AUD_MISMATCH, b.NETWORK_TOKEN_AUD_MISSING].includes(t3.muxCode)) return "403-incorrect-aud-value.md";
    if (t3.muxCode === b.NETWORK_TOKEN_SUB_MISMATCH) return "403-playback-id-mismatch.md";
    if (t3.muxCode === b.NETWORK_TOKEN_MISSING) return "missing-signed-tokens.md";
    if (t3.muxCode === b.NETWORK_NOT_FOUND) return "404-not-found.md";
    if (t3.muxCode === b.NETWORK_NOT_READY) return "412-not-playable.md";
  }
  if (t3.code) {
...
var Ne3 = class extends Ce3 {
  ...
  async requestFullscreen(e2) {
    var i2;
    if (!(!this.mediaController || this.mediaController.hasAttribute(MediaUIAttributes.MEDIA_IS_FULLSCREEN))) return (i2 = this.mediaController) == null || i2.dispatchEvent(new k2.CustomEvent(MediaUIEvents.MEDIA_ENTER_FULLSCREEN_REQUEST, { composed: true, bubbles: true })), new Promise((r12, n3) => {
      var d4;
  ...
  async exitFullscreen() {
    var e2;
    if (!(!this.mediaController || !this.mediaController.hasAttribute(MediaUIAttributes.MEDIA_IS_FULLSCREEN))) return (e2 = this.mediaController) == null || e2.dispatchEvent(new k2.CustomEvent(MediaUIEvents.MEDIA_EXIT_FULLSCREEN_REQUEST, { composed: true, bubbles: true })), new Promise((i2, r12) => {
      var n3;
  ...
  get poster() {
    ...
    if (this.playbackId && !this.audio) return ot3(this.playbackId, { customDomain: this.customDomain, thumbnailTime: (r12 = this.thumbnailTime) != null ? r12 : this.startTime, programTime: this.programStartTime, token: i2.thumbnail });
  }
  set poster(e2) {
  ...
  get primaryColor() {
    ...
    if (e2 != null || this.mediaTheme && (e2 = (r12 = (i2 = k2.getComputedStyle(this.mediaTheme)) == null ? void 0 : i2.getPropertyValue("--_primary-color")) == null ? void 0 : r12.trim(), e2)) return e2;
  }
  set primaryColor(e2) {
  ...
  get secondaryColor() {
    ...
    if (e2 != null || this.mediaTheme && (e2 = (r12 = (i2 = k2.getComputedStyle(this.mediaTheme)) == null ? void 0 : i2.getPropertyValue("--_secondary-color")) == null ? void 0 : r12.trim(), e2)) return e2;
  }
  ...
  get accentColor() {
    ...
    if (e2 != null || this.mediaTheme && (e2 = (r12 = (i2 = k2.getComputedStyle(this.mediaTheme)) == null ? void 0 : i2.getPropertyValue("--_accent-color")) == null ? void 0 : r12.trim(), e2)) return e2;
  }
  set accentColor(e2) {
...
mux-embed/dist/mux.mjs:
  ...
  *)
*/
//# sourceMappingURL=dist-RZFKBB32.js.map
